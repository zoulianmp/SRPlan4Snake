...
void qSlicerSettingsModulesPanelPrivate::init()
{
  ...
  this->ModulesMenu->setCurrentModule(SRPlan_DEFAULT_HOME_MODULE);
  ...
  QStringList favoritesRaw = QString(SRPlan_DEFAULT_FAVORITE_MODULES).split(",", QString::SkipEmptyParts);
