...
#include "qSRPlanAnnotationsModuleWidgetsExport.h"
...
class Q_SRPlan_MODULE_ANNOTATIONS_WIDGETS_EXPORT
...
public:
  ...
  qMRMLAnnotationRulerProjectionPropertyWidget(QWidget *newParent = 0);
