...
#include "qSRPlanAnnotationsModuleExport.h"

class qSlicerAbstractModuleWidget;
class qSlicerAnnotationsModulePrivate;

/// \ingroup Slicer_QtModules_Annotation
class Q_SRPlan_QTMODULES_ANNOTATIONS_EXPORT qSlicerAnnotationsModule :
  public qSlicerLoadableModule
{
  Q_OBJECT
  Q_PLUGIN_METADATA(IID "qSlicerAnnotationsModule" FILE "qSlicerAnnotationsModule.JSON")
