...
#ifndef __qMRMLMarkupsFiducialProjectionPropertyWidgetPlugin_h
#define __qMRMLMarkupsFiducialProjectionPropertyWidgetPlugin_h

#include "qSlicerMarkupsModuleWidgetsAbstractPlugin.h"

class Q_SRPlan_MODULE_MARKUPS_WIDGETS_PLUGINS_EXPORT
...
public:
  qMRMLMarkupsFiducialProjectionPropertyWidgetPlugin(QObject *_parent = 0);
