...
#include "qSRPlanMarkupsSubjectHierarchyPluginsExport.h"
...
class Q_SRPlan_MARKUPS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qSlicerSubjectHierarchyMarkupsPlugin : public qSlicerSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
