...
#include "qSRPlanModelsSubjectHierarchyPluginsExport.h"
...
class Q_SRPlan_MODELS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qSlicerSubjectHierarchyModelsPlugin : public qSlicerSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  /// Get icon of a owned subject hierarchy node
