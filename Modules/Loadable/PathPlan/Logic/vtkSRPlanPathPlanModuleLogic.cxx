...
// \ingroup
class vtkSRPlanPathPlanModuleLogicCallback : public vtkCommand
{
public:
  static vtkSRPlanPathPlanModuleLogicCallback *New()
  { return new vtkSRPlanPathPlanModuleLogicCallback; }

  vtkSRPlanPathPlanModuleLogicCallback(){}
  ...
  void SetLogic(vtkSRPlanPathPlanModuleLogic *logic)
  {
    this->markupsLogic = logic;
  }
  vtkSRPlanPathPlanModuleLogic * markupsLogic;
};
...
vtkSRPlanPathPlanModuleLogic::vtkSRPlanPathPlanModuleLogic()
{
  ...
  vtkNew<vtkSRPlanPathPlanModuleLogicCallback> myCallback;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ProcessMRMLNodesEvents(vtkObject *caller,
                                                   unsigned long event,
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ObserveMRMLScene()
{
...
//-----------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::RegisterNodes()
{
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::UpdateFromMRMLScene()
{
  assert(this->GetMRMLScene() != 0);
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
  if (!node)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  // remove observer
  if (!node)
    {
...
//---------------------------------------------------------------------------
std::string vtkSRPlanPathPlanModuleLogic::GetSelectionNodeID()
{
...
//---------------------------------------------------------------------------
std::string vtkSRPlanPathPlanModuleLogic::GetActiveListID()
{
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetActiveListID(vtkMRMLMarkupsNode *markupsNode)
{
  std::string selectionNodeID = this->GetSelectionNodeID();
  vtkMRMLNode *node = this->GetMRMLScene()->GetNodeByID(selectionNodeID.c_str());
  vtkMRMLSelectionNode *selectionNode = NULL;
...
//---------------------------------------------------------------------------
std::string vtkSRPlanPathPlanModuleLogic::AddNewDisplayNodeForMarkupsNode(vtkMRMLNode *mrmlNode)
{
  std::string id;
...
//---------------------------------------------------------------------------
std::string vtkSRPlanPathPlanModuleLogic::AddNewFiducialNode(const char *name, vtkMRMLScene *scene)
{
  std::string id;
...
//---------------------------------------------------------------------------
int vtkSRPlanPathPlanModuleLogic::AddFiducial(double r, double a, double s)
{
  if (!this->GetMRMLScene())
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::JumpSlicesToLocation(double x, double y, double z, bool centered)
{
  if (!this->GetMRMLScene())
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::JumpSlicesToNthPointInMarkup(const char *id, int n, bool centered)
{
  if (!id)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::FocusCamerasOnNthPointInMarkup(const char *id, int n)
{
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::FocusCameraOnNthPointInMarkup(
...
//---------------------------------------------------------------------------
char * vtkSRPlanPathPlanModuleLogic::LoadMarkupsFiducials(const char *fileName, const char *fidsName)
{
  char *nodeID = NULL;
  std::string idList;
  if (!fileName)
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetAllMarkupsVisibility(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ToggleAllMarkupsVisibility(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetAllMarkupsLocked(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ToggleAllMarkupsLocked(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetAllMarkupsSelected(vtkMRMLMarkupsNode *node, bool flag)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ToggleAllMarkupsSelected(vtkMRMLMarkupsNode *node)
{
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeGlyphType(int glyphType)
{
  this->DefaultMarkupsDisplayNode->SetGlyphType(glyphType);
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeGlyphTypeFromString(const char *glyphType)
{
  if (glyphType == NULL)
    {
...
//---------------------------------------------------------------------------
int vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeGlyphType()
{
  return this->DefaultMarkupsDisplayNode->GetGlyphType();
}

//---------------------------------------------------------------------------
std::string vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeGlyphTypeAsString()
{
...
//---------------------------------------------------------------------------
double vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeGlyphScale()
{
  return this->DefaultMarkupsDisplayNode->GetGlyphScale();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeGlyphScale(double scale)
{
  this->DefaultMarkupsDisplayNode->SetGlyphScale(scale);
}

//---------------------------------------------------------------------------
double vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeTextScale()
{
  return this->DefaultMarkupsDisplayNode->GetTextScale();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeTextScale(double scale)
{
  this->DefaultMarkupsDisplayNode->SetTextScale(scale);
}

//---------------------------------------------------------------------------
double vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeOpacity()
{
  return this->DefaultMarkupsDisplayNode->GetOpacity();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeOpacity(double opacity)
{
  this->DefaultMarkupsDisplayNode->SetOpacity(opacity);
}

//---------------------------------------------------------------------------
double *vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeColor()
{
  return this->DefaultMarkupsDisplayNode->GetColor();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeColor(double *color)
{
  if (!color)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeColor(double r, double g, double b)
{
  this->DefaultMarkupsDisplayNode->SetColor(r,g,b);
}

//---------------------------------------------------------------------------
double *vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeSelectedColor()
{
  return this->DefaultMarkupsDisplayNode->GetSelectedColor();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSelectedColor(double *color)
{
  if (!color)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSelectedColor(double r, double g, double b)
{
  this->DefaultMarkupsDisplayNode->SetSelectedColor(r,g,b);
}

//---------------------------------------------------------------------------
int vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeSliceProjection()
{
  return this->DefaultMarkupsDisplayNode->GetSliceProjection();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSliceProjection(int projection)
{
  this->DefaultMarkupsDisplayNode->SetSliceProjection(projection);
}

//---------------------------------------------------------------------------
double *vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeSliceProjectionColor()
{
  return this->DefaultMarkupsDisplayNode->GetSliceProjectionColor();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSliceProjectionColor(double *color)
{
  if (!color)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSliceProjectionColor(double r, double g, double b)
{
  this->DefaultMarkupsDisplayNode->SetSliceProjectionColor(r,g,b);
}

//---------------------------------------------------------------------------
double vtkSRPlanPathPlanModuleLogic::GetDefaultMarkupsDisplayNodeSliceProjectionOpacity()
{
  return this->DefaultMarkupsDisplayNode->GetSliceProjectionOpacity();
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDefaultMarkupsDisplayNodeSliceProjectionOpacity(double opacity)
{
  this->DefaultMarkupsDisplayNode->SetSliceProjectionOpacity(opacity);
}

//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetDisplayNodeToDefaults(vtkMRMLMarkupsDisplayNode *displayNode)
{
  if (!displayNode)
    {
    return;
...
//---------------------------------------------------------------------------
bool vtkSRPlanPathPlanModuleLogic::MoveNthMarkupToNewListAtIndex(int n, vtkMRMLMarkupsNode *markupsNode,
...
//---------------------------------------------------------------------------
bool vtkSRPlanPathPlanModuleLogic::CopyNthMarkupToNewList(int n, vtkMRMLMarkupsNode *markupsNode,
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::ConvertAnnotationFiducialsToMarkups()
{
  if (!this->GetMRMLScene())
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::RenameAllMarkupsFromCurrentFormat(vtkMRMLMarkupsNode *markupsNode)
{
  if (!markupsNode)
    {
    return;
...
//---------------------------------------------------------------------------
bool vtkSRPlanPathPlanModuleLogic::StartPlaceMode(bool persistent)
{
  if (!this->GetMRMLScene())
    {
...
//---------------------------------------------------------------------------
int vtkSRPlanPathPlanModuleLogic::GetSliceIntersectionsVisibility()
{
  if (!this->GetMRMLScene())
    {
...
//---------------------------------------------------------------------------
void vtkSRPlanPathPlanModuleLogic::SetSliceIntersectionsVisibility(bool flag)
{
  if (!this->GetMRMLScene())
    {
    return;
