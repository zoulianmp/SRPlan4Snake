...
#include "qSRPlanVolumesModuleWidgetsExport.h"
...
class Q_SRPlan_QTMODULES_VOLUMES_WIDGETS_EXPORT qSlicerDiffusionWeightedVolumeDisplayWidget : public qSlicerWidget
{
  Q_OBJECT
  QVTK_OBJECT
public:
