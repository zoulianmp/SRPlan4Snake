...
// Transforms includes
#include "qSRPlanTransformsModuleExport.h"

class vtkMatrix4x4;
class vtkMRMLNode;
class qSlicerTransformsModulePrivate;

class Q_SRPlan_QTMODULES_TRANSFORMS_EXPORT qSlicerTransformsModule
  : public qSlicerLoadableModule
{
  Q_OBJECT
  Q_PLUGIN_METADATA(IID "qSlicerTransformsModule" FILE "qSlicerTransformsModule.JSON")
