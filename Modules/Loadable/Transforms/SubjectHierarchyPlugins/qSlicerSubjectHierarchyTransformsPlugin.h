...
#include "qSRPlanTransformsSubjectHierarchyPluginsExport.h"
...
class Q_SRPlan_TRANSFORMS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qSlicerSubjectHierarchyTransformsPlugin : public qSlicerSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
