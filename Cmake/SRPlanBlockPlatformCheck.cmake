...
#
# SRPlan Platform check
#

#
# Usage:
#   The check can be enabled/disabled by setting SRPlan_PLATFORM_CHECK to
#   True/False before including the block.
#

if(NOT DEFINED SRPlan_PLATFORM_CHECK)
  set(SRPlan_PLATFORM_CHECK true)
endif()

if(SRPlan_PLATFORM_CHECK)
  ...
  # CMake 2.8.11 is required to build SRPlan on Mountain Lion
  ...
  if(MSVC)
    ...
    if(MSVC90 AND NOT "${CMAKE_CXX_COMPILER_VERSION}" VERSION_EQUAL "15.00.30729.01")
      message(FATAL_ERROR "SRPlan requires Microsoft Visual Studio 2008 (VS9) SP1 or greater!"
