...
macro(SRPlanMacroBuildModuleVTKLibrary)
  set(options
    DISABLE_WRAP_PYTHON
    NO_INSTALL
    )
  ...
  if(MODULEVTKLIBRARY_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "Unknown keywords given to SRPlanMacroBuildModuleVTKLibrary(): \"${MODULEVTKLIBRARY_UNPARSED_ARGUMENTS}\"")
  endif()
  ...
  if(DEFINED SRPlan_DEVELOPMENT_INSTALL)
    if(NOT DEFINED ${MODULEVTKLIBRARY_NAME}_DEVELOPMENT_INSTALL)
      set(${MODULEVTKLIBRARY_NAME}_DEVELOPMENT_INSTALL ${SRPlan_DEVELOPMENT_INSTALL})
    endif()
  else()
    if(NOT DEFINED ${MODULEVTKLIBRARY_NAME}_DEVELOPMENT_INSTALL)
  ...
  if(NOT MY_NO_INSTALL AND ${MODULEVTKLIBRARY_NAME}_DEVELOPMENT_INSTALL)
    ...
    install(FILES
      ${headers}
      ${dynamicHeaders}
      DESTINATION ${SRPlan_INSTALL_QTLOADABLEMODULES_INCLUDE_DIR}/${MODULEVTKLIBRARY_NAME} COMPONENT Development
      )
  endif()
  ...
  # Export target
  # --------------------------------------------------------------------------
  set_property(GLOBAL APPEND PROPERTY SRPlan_TARGETS ${MODULEVTKLIBRARY_NAME})
